...
Read-only cases should produce no project diff. The approved-trial case permits only the project-local changes described by its oracle. Never run these fixtures against a real project, installed Skill directory, or GitHub checkout containing unpublished user work.
